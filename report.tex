...
% With text removed, for the plagiarism checker
%\newcommand{\notinplag}[1]{}
...
\begin{itemize}
    \item \textbf{Dr. \pawel{}} for his input on the project and directing me
        towards the input types being the key;
    \item \textbf{Sue Skelton} and \textbf{Barnaby Gale} for
        proofreading this report;
    \item \textbf{Edward Kmett}, \textbf{David Luposchainsky} and the others
        on \textbf{\#haskell} for their help with my learning the Haskell
        ecosystem and associated maths.
\end{itemize}
